...
const EditChart = (props) => {
    ...
    const { loading: dashboardItemsLoading, error: dashboardItemsError, data: dashboardItemsData } = useDataQuery(dashboardItemsQuery)
    const { loading: dataElementsLoading, error: dataElementsError, data: dataElementsData } = useDataQuery(dataElementsQuery)
    ...
    console.log('jj EditChart:', props.dashboardItemId, chartType)
    console.log('jj dashboardItems:', dashboardItemsData?.dashboardItems)

    return (
        <div>
            <p>EditChart Component</p>
            ...
            <button onClick={saveConfigToDataStore} disabled={saveLoading || dashboardItemsLoading}>
                {saveLoading ? 'Saving...' : 'Save to DataStore'}
            </button>
            {dataElementsError && <div style={{ color: 'red' }}>Data Elements Error: {dataElementsError.message}</div>}
